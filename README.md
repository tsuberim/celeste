# Video genration model trained on Celeste gameplay footage

Abstract:
---
- This work shows a working implementation and results of a video generation model trained on raw gameplay footage of the game "Celeste". 
...
Data:
- [~4.5hr gameplay footage](https://www.youtube.com/watch?v=z8r255LoVJc)
- 12fps (sub-sampled)
...
Below is the result of video contiuation generation (the first half is grouth truth footage, the second half is generated by the model):
...
- latent action model to learng implicit actions from raw footage
